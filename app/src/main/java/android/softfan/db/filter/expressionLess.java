...
public class expressionLess extends expressionBase {

	private String	field;

	public expressionLess() {
	}

	public expressionLess(String field, Object value) {
		this.field = field;
		this.value = value;
	}
	...
	public expressionBase getCopy() {
		expressionLess expression = new expressionLess();
